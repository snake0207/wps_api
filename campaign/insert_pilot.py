...
# defining the api-endpoint, Pilot 캠페인 등록
URL = 'http://112.216.38.190:9180/openapi/campaign/insert/pilot'
...
send_body = {'campTitle': '', 'campPurpose': '', 'fromDate': '', 'areas': [{'areaType': '',  # LIST 자료
                                                                            'cdntType': '', 'x': '', 'y': '',
                                                                            'radius': '', 'addr': '', 'addrCd': ''}],
             'apps': [{'appId': ''  # LIST 자료
                       }]}
